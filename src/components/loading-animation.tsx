...
const LoadingAnimation: React.FC<LoadingAnimationProps> = ({ onComplete }) => {
  const [animationStage, setAnimationStage] = useState<"initial" | "moving" | "zooming" | "complete">("initial");

  useEffect(() => {
    // Phase 1: Initial Hold (1s)
    const holdTimer = setTimeout(() => {
      setAnimationStage("moving");
    }, 1000);

    // Phase 2: Logo halves move in (1.2s) + pause (0.3s)
    const moveTimer = setTimeout(() => {
      setAnimationStage("zooming");
    }, 2500);

    // Phase 3: Zoom out and fade (1.5s)
    ...
    >
      ...
      <div
        ...
        style={{
          left: "50%",
          top: "50%",
          transform: `translate(-50%, -50%) scale(${animationStage === "zooming" ? 1.4 : 1})`,
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            transform: `translate(-50%, -50%) scale(${
              animationStage === "moving" || animationStage === "zooming" ? 0.73 : 0.6
            })`,
            background: "radial-gradient(circle, rgba(160,160,160,0.25) 0%, rgba(110,110,110,0.18) 40%, rgba(60,60,60,0.06) 70%, rgba(0,0,0,0) 100%)",
            opacity: animationStage === "moving" || animationStage === "zooming" ? 0.75 : 0,
            transition: "all 1.2s ease",
        ...
        <div
          ...
          style={{
            ...
            top: "50%",
            transform: `translate(-50%, -50%) scale(${
              animationStage === "zooming" ? 1.6 : animationStage === "moving" ? 1 : 0.7
            })`,
            background: "radial-gradient(circle, rgba(160,160,160,0.25) 0%, rgba(110,110,110,0.18) 40%, rgba(60,60,60,0.06) 70%, rgba(0,0,0,0) 100%)",
            backdropFilter: "blur(3px)",
            opacity: animationStage === "zooming" ? 0 : animationStage === "moving" ? 1 : 0,
        ...
        <div
          ...
          style={{
            ...
            top: "50%",
            transform: `translate(${
              animationStage === "initial" ? "calc(-50% - 300px)" : "-50%"
            }, calc(-50% - 65px)) scale(0.7)`,
